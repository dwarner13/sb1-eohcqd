        ...
        <div className="mx-auto max-w-7xl px-6 py-24 lg:px-8">
          ...
          <div className="mx-auto max-w-2xl lg:max-w-none">
            ...
            <div className="mt-24 bg-blue-50 rounded-2xl p-12 text-center">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600">
                Whether you need <Link to="/" className="text-blue-600 hover:text-blue-500 font-semibold">emergency repairs</Link> or <Link to="/" className="text-blue-600 hover:text-blue-500 font-semibold">routine maintenance</Link>, our team is here to help.
              </p>
