    ...
    <>
      ...
      <main className="bg-white">
        ...
        <div className="mx-auto max-w-7xl px-6 py-24 lg:px-8">
          ...
          {/* Service Guarantee */}
          <div className="mb-24 bg-blue-50 rounded-2xl p-12">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="text-3xl font-bold tracking-tight text-gray-900 mb-6">
                Our Service Guarantee
              </h2>
              <p className="text-lg leading-8 text-gray-600 mb-8">
                We provide <Link to="/" className="text-blue-600 hover:text-blue-500 font-semibold">guaranteed satisfaction</Link> and <Link to="/" className="text-blue-600 hover:text-blue-500 font-semibold">professional service</Link> throughout our coverage area. All repairs come with our standard <Link to="/" className="text-blue-600 hover:text-blue-500 font-semibold">90-day warranty</Link>.
              </p>
              <Link
                to="/contact"
                className="inline-block rounded-md bg-blue-600 px-6 py-3 text-lg font-semibold text-white hover:bg-blue-500"
              >
                Schedule Service
              </Link>
            </div>
          ...
          <div>
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="text-lg leading-8 text-gray-600 mb-8">
                We're constantly expanding our service area to better serve the Greater Edmonton region. Contact us to check if we service your location or to learn about our <Link to="/" className="text-blue-600 hover:text-blue-500 font-semibold">special service arrangements</Link> for outlying areas.
              </p>
              <Link
                to="/contact"
