      ...
      <main className="bg-white">
        ...
        <div className="mx-auto max-w-7xl px-6 py-24 lg:px-8">
          ...
          <div className="mt-24 bg-blue-50 rounded-2xl p-12 text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Our <Link to="/" className="text-blue-600 hover:text-blue-500 font-semibold">expert technicians</Link> are available 24/7 for 
              <Link to="/" className="text-blue-600 hover:text-blue-500 font-semibold">emergency repairs</Link>. 
            </p>
